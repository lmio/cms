...
class Url:
    ...
    def from_url(self, url):
        """Construct a URL from a previously generated URL.

        If the given URL doesn't seem to be generated by this class,
        just return the base URL.

        url (str): the previously generated URL.

        return (str): the new generated URL.
        ...
        if not o.path or o.path == "/":
            new_url = self.url_root
        else:
            new_url = self(*o.path.strip("/").split("/"))
