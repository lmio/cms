...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "cmsGenerateDistrictSubmissionArchives=cmscontrib.GenerateDistrictSubmissionArchives:main",
        ...
        "cms.grading.scoretypes": [
            ...
            "SimpleGroupMin=cms.grading.scoretypes.simple_group:SimpleGroupMin",
        ],
        "cms.grading.languages": [
            ...
            "Python 3.13 / CPython=cms.grading.languages.python313_cpython:Python313CPython",
